...
export const useCartStore = defineStore('historycart', () => {
  ...
  function saveCart() {
    localStorage.setItem('historycart', JSON.stringify(cart.value))
  }

  // Load cart from localStorage if available
  function loadCart() {
    const savedCart = localStorage.getItem('historycart')
    if (savedCart) {
